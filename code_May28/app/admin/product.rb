ActiveAdmin.register Product do
  ...
  permit_params :name, :prices, :category_id, :restaurant_id, :images,product_components_attributes:[:id,:component_value_id,product_id:[:id],:_destroy=>true]
  ...
  form :html => { :enctype => "multipart/form-data" } do |f|
    ...
    f.inputs "Product Component" do
      f.has_many :product_components ,allow_destroy: true do |a|
       a.input :component_value_id,as: :select,collection: ComponentValue.select(:id, :name).uniq
